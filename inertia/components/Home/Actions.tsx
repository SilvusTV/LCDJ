    ...
    <div className={'relative bg-blue-dark flex flex-col items-center'}>
      ...
      >
        ...
        >
          ...
          />
          <p className={'text-xl text-justify bg-orange-light p-10 rounded-xlg'}>
            Les paniers sont ensuite distribués au cours de distributions aux jeunes de 18 à 30 ans
            préalablement inscrits. Nous en organisons une grosse par mois, dans le 9e et 18e
