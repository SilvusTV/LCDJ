  ...
  return (
    <div className={'h-screen bg-orange-dark flex flex-col items-center'}>
      ...
      <div className={'grid grid-cols-2 grid-rows-3 gap-10 h-3/4 w-4/5'}>
        <a
          className={
            'row-span-2 bg-[url(/inertia/images/news/1.jpg)] bg-center bg-cover bg-no-repeat max-sm:col-span-2 max-sm:row-span-2 flex items-end'
          }
          href={'#'}
        >
        ...
        <a
          className={
            'bg-[url(/inertia/images/news/2.jpg)] bg-center bg-cover bg-no-repeat max-sm:row-start-3 flex items-end'
          }
        ...
        <a
          className={
            'bg-[url(/inertia/images/news/3.jpg)] bg-center bg-cover bg-no-repeat col-start-2 max-sm:row-start-3 flex items-end'
          }
